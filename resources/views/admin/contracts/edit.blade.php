    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror"
                                  ...
                                  style="font-family: 'Menlo', 'Consolas', 'Courier New', monospace; line-height: 1.7;">{{ old('content', $contract->content) }}</textarea>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    @include('admin.partials.client-select', ['clients' => $clients, 'selected' => old('client_id', $contract->client_id)])
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('project_name') is-invalid @enderror" id="project_name" name="project_name" value="{{ old('project_name', $contract->project_name) }}" placeholder="供 @{{project_name}} 佔位符使用；留空則自動帶入上方關聯專案名稱">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="yearly_fee" name="yearly_fee"
                                   value="{{ old('yearly_fee', $contract->yearly_fee) }}" min="0" step="0.01" placeholder="例如：7000">
                        </div>
